...
public interface MapperReceivable {
	...
	List<File_rtgs_awb_core> get_credit_for_recon();

	@Select("select * from data_recivable where status = 1 and availability = 1 and dr_cr='DR'")
	List<File_rtgs_awb_core> get_debit_for_recon();
...
//	List<File_rtgs_awb_core> get_receivable_credit_for_recon_auto(@Param("account_id") Long account_id);
...
//	List<File_rtgs_awb_core> get_receivable_debit_for_recon_auto(@Param("account_id") Long account_id);
	...
	List<File_rtgs_awb_core> get_receivable_credit_matched(@Param("account_id") Long account_id,
	...
	List<File_rtgs_awb_core> get_receivable_debit_matched(@Param("account_id") Long account_id,
			@Param("match_date") String match_date);
	...
	List<File_rtgs_awb_core> get_receivable_credit_matched_with_reason(@Param("account_id") Long account_id);
	...
	@Select("		select  distinct rac.id, rac.posting_date, rac.transaction_reference, rac.branch_code,"
			...
			+ "					 and urm.user_id=u.id and urm.receivable_matched_id=rm.id and urm.availability=1 and rm.match_id=mr.match_id and urm.status=1")
	List<File_rtgs_awb_core> get_receivable_debit_matched_with_reason(@Param("account_id") Long account_id);
	...
	List<File_rtgs_awb_core> reportReceivableDebit(@Param("date") String date);
	...
	List<File_rtgs_awb_core> reportReceivableCredit(@Param("date") String date);
	...
	List<File_rtgs_awb_core> getPayableRawData(@Param("id") long id);
